...
agpt_configs = {
    "proxy1bllama2": _build_agpt_config(
        dim=640,
        n_layers=7,
        n_heads=8,
        n_kv_heads=2,
...
agpt_configs["1b"] = agpt_configs["1B"]
...
agpt_configs["300m"] = agpt_configs["300M"]
